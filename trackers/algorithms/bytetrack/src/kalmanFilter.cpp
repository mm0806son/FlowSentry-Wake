...
KAL_DATA
KalmanFilter::initiate(const DETECTBOX &measurement)
{
...
KAL_HDATA
KalmanFilter::project(const KAL_MEAN &mean, const KAL_COVA &covariance)
{
  DETECTBOX std;
...
KalmanFilter::gating_distance(const KAL_MEAN &mean, const KAL_COVA &covariance,
